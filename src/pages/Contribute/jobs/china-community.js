                        ...
                        <Row>
                                ...
                                <div className=" position-relative">
                                    <div className="rounded shadow">
                                        <div className="text-center py-5 border-bottom">
                                            ...
                                            <p className="text-muted mb-0">Community Manager - China</p>
                                        </div>
                            ...
                            <Col lg="8" md="7" xs="12" className="mt-4 mt-sm-0 pt-2 pt-sm-0">
                                <div className="ml-md-4">
                                    ...
                                    <p>The role of the Community Manager - China is to create a following and dedicated community in Chinese speaking regions. This will involve creating localised communities on social platforms most popular in the region, and spreading awareness to continuously grow the community.</p>
