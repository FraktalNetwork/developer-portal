                        ...
                        <Row>
                                ...
                                <div className=" position-relative">
                                    <div className="rounded shadow">
                                        <div className="text-center py-5 border-bottom">
                                            ...
                                            <p className="text-muted mb-0">Korean Translator</p>
                                        </div>
                            ...
                            <Col lg="8" md="7" xs="12" className="mt-4 mt-sm-0 pt-2 pt-sm-0">
                                <div className="ml-md-4">
                                    ...
                                    <p>This position is for someone with a strong grasp on both the Korean and English languages who is comfortable translating (sometimes technical) topics from English to Korean.</p>
